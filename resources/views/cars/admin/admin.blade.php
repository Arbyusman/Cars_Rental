    ...
    <main id="main" class="mt-1 container-fluid">
        <section class="mb-4">
            ...
            <form action="/admin" method="GET">
                <input name="hostel1" value="Small" type="hidden">
                <button class="filter-button btn btn-primary" data-value="All" id="button_all" type="button">ALL</button>
                <button class="filter-button btn btn-primary" data-value="Small" id="button_small"
                    type="Submit">Small</button>
                ...
                <section id="tampil_mobil ">
                    <div class="card  mt-2 container-fluid">
                        ...
                        <div class="card-body ms-0 me-0">
                            ...
                            <div id="button_card"
                                class=" d-flex  flex-row justify-content-between align-items-baseline mt-2">
