...
@section('content')
    ...
    <section class="container-fluid p-0" id="cari-mobil" style="width: 80%; margin-top: -4%; position: sticky">
        <form action="/search" method="GET" class="container-fluid d-flex flex-row justify-content-center align-items-center rounded-2"
            id="menu-cari-mobil"
            style="
          background: #ffffff;
          border-radius: 8px;
        ...
        ">
            ...
            <input type="text" name="query" class="btn-cari-mobil  text-dark fw-bold border-2 me-2 mt-4 rounded-1 "
                style="background: #eff0ef; height: 50%; width: 100%
                    " />
    ...
    <section class="container-fluid  pt-7 mt-4" id="cari-mobil" style="width: 80%; ">
